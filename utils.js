...
async function getTime() {
    ...
    importantDates = [
      ...
      { date: 'May 3, 2023', name: 'English A: Literature HL & SL - Paper 1' },
      { date: 'May 4, 2023', name: 'English A: Literature HL & SL - Paper 2' },
      ...
      { date: 'May 8, 2023', name: 'Computer Science HL - Paper 2 & 3' },
      { date: 'May 8, 2023', name: 'AP BC Calculus Exam' },
      ...
      { date: 'May 19, 2023', name: 'AP BC Calculus Retake Exam' },
      { date: 'May 22, 2023', name: 'Last Day of School for Seniors' },
      { date: 'May 29, 2023', name: 'Memorial Day'},
